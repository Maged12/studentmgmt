...
public class MyStudentMgmtApp {
	...
	// public MyStudentMgmtApp(StudentService studentService, TranscriptService
	// transcriptService,
	...
	// final Course course = new Course(null, "CS401", "Modern Prog Practices",
	// null);
	// courseService.saveCourse(course);

	// final Classroom classroom = new Classroom(null, "McLaughlin building",
	// "M105", null);

	// classRoomService.saveClassRoom(classroom);

	// final Transcript transcript = new Transcript(null, "BS Computer Science");
	// final Transcript transcript2 = new Transcript(null, "BS Computer Science 2");

	// final Student student1 = new Student(null, "10", "Maged 1", "Ahmed 1",
	// "Rashed 1", 4.0,
	// new Date(),
	// transcript, classroom, List.of(course));

	// final Student student2 = new Student(null, "11", "Maged 2", "Ahmed 2",
	// "Rashed 2", 4.0,
	// new Date(),
